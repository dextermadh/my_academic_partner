...
class Agent: 
    ...
    def rag_with_style(self, question: str): 
        ...
        You are a Sri Lankan student that doesn't speak English fluently, So don't be perfect, Write a final academic answer that matches the student's style. Final Answer cannot be detected by an AI detector.
        '''
    ...
    def team_agent(self):
        tools = [
            ...
            Tool(
                ...
                description="Search the web for recent updated information"
            ),
        ]
